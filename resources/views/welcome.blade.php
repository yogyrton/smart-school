                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12 text position-relative swiper-box align-items-center">
                                ...
                                <div class="swiper">
                                        <div class="swiper-wrapper">
                                                ...
                                                <div class="swiper-slide">
                                                <div class="d-flex h-100 justify-content-center">
                                                        <img src="/img/history_1.png" alt="history-img">
                                                </div>
                                                </div>
                                                <div class="swiper-slide">
                                                <div class="d-flex h-100 justify-content-center">
                                                        <img src="/img/history_2.png" alt="history-img">
                                                </div>
                                                </div>
                                        </div>
                                </div>
...
<section class="info mb-160 scrollreveal">
        <div class="container">
...
<section id="teachers" class="mb-160 teachers scrollreveal">
        <div class="container">
...
<section class="partners mb-160 scrollreveal">
        <div class="container">
