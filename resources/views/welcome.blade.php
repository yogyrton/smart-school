        ...
        <div class="container">
            ...
            <div class="row align-items-center justify-content-between">
                <div class=" col-7 text history-text-box">
                    <p class="pb-10">
                        В 2015 году при содействии лучших методистов Беларуси и Европы был открыт Инновационный Детский
                        Образовательный Центр "Фабрика Звезд", на базе которого мы разработали уникальную программу для
                        школьников по нейробике, кинезиологии и эмоциональному интеллекту «Секрет успешного обучения».
                ...
                <div class="col-6 flex-column">
                    <ul class="advantages-list-1">
                        <li class="text mb-20 li"><span class="text-bold ">«Смарт Скул» </span> — это официальное
                            частное учреждение образования в Беларуси, России, Грузии, Польше.
                        </li>
                        ...
                        <li class="text mb-20"><span class="text-bold ">Наша цель</span> - воспитание счастливых,
                            ...
                            сотрудничать, заботливых, творческих, компетентных, ответственных взрослых ЗАВТРА.
                        </li>
                        ...
                        <li class="text mb-20"><span class="text-bold ">Наши учащиеся</span> знают и ценят свои права,
                            национальные и общемировые ценности и культуру, осознают себя гражданами своей страны и
                            всего мира.
                        </li>
                    </ul>
            ...
            <div class="row d-flex">
                ...
                <div class="col-3">
                    <div class="d-flex flex-column align-items-center  info-box">
                        ...
                        <p class="text grey text-center">предлагает наша школа для </br>обучения из разных точек
                            мира</p>
                    </div>
                </div>
                <div class="col-3">
                        ...
                        <div class="priority-box d-flex mb-40">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <p class="text">Гибкая интерактивная среда обучения, где учащиеся активно и уверенно
                                    участвуют в собственном образовании.</p>
                            </div>
                        </div>
                        <div class="priority-box d-flex mb-40">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-12">
                                    ...
                                    <input type="text" id="contact_name" name="contact_name" autocomplete="off"
                                           placeholder="Введите Ваше имя" class="w-100 text" required>
                                </div>

                                <div class="mb-12">
                                    <label for="contact_phone">Телефон*</label>
                                    <input type="text" title="+375 (25/29/33/44) XXX-XX-XX" autocomplete="off"
                                           pattern="\+375\s?[\(]{0,1}(25|29|33|44)[\)]{0,1}\s?\d{3}[-]{0,1}\d{2}[-]{0,1}\d{2}"
                                           placeholder="Введите номер телефона" id="contact_phone" name="contact_phone"
                                           class="w-100 input-mask__phone text" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-12">
                                    <label for="contact_email">Email*</label>
                                    <input type="text" pattern="(\w+[.]?\w+?@\w+?\.[a-z]{2,4})" autocomplete="off"
                                           placeholder="Введите email для связи*" id="contact_email"
                                           name="contact_email" class="w-100 input-mask__mail text">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
