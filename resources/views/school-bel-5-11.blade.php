...
@section('description', 'Оффлайн и онлайн обучение для 5-11 классов в Беларуси и России. Театральная студия, занятия с репетитором, факультативы, подготовка к ЦТ, курсы, лагеря.')
@section('content')
@php($routeName = Route::current()->getName())
    ...
    <section id="head" class="head mb-120 position-relative @if(!empty($mainNews)  && count($mainNews) > 0) notification-size @endif">
        <div class="container">
            ...
            <div class="head--container centered-mobile">
                <div>
                    <img src="/img/main/banners/new4.webp" alt="main-banner" class="d-none d-md-block banner-image">
                    <img src="/img/main/banners/school-belarus-senior-mob.webp" alt="main-banner-mob" class="banner-image d-block d-md-none">
                </div>
            ...
            <div class="row align-items-center justify-content-between container-mob">
                <div class=" col-lg-7 text order-2 order-lg-7">
                    <div class="history-text-box">
                        <p class="pb-10">
                            «Смарт Скул» — это официальное частное учреждение образования в Беларуси и России.
                        </p>
                        <p class="pb-10">
    ...
    <section id="price" class="pb-120 scrollreveal">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <img src="/img/main/price/senior.jpg" alt="price-img" class="border-20 img-fluid mb-20">
                    ...
                    <div class="swiper-box d-block d-lg-none">
                        <div class="swiper">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    <div class="price--card">
                                        <div class="d-flex align-items-start mb-3">
                                            ...
                                            <span>Пребывание в школе: <br>8:00-15:30/19:00 (начало уроков в 9:00);</span>
                                        </div>
                                        <div class="d-flex align-items-start mb-3">
                                            <img src="/svg/food.svg" alt="food-img" class="me-2">
                                            <span>Питание: завтрак, обед, после 15:30 полдник;</span>
                                        </div>
                                ...
                                <div class="swiper-slide">
                                    <div class="price--card d-flex align-items-center mb-20">
                                        <img src="/svg/twemoji_books.svg" alt="program-img" class="me-2">
                                        <p class="mb-0">
                                    ...
                                    <div class="price--card d-flex align-items-center">
                                        <p class="mb-0">
                                            Дополнительные занятия на выбор английский язык /математика (2)
                                        </p>
                                    </div>
                                </div>
                                <div class="swiper-slide">
                                ...
                                <div class="swiper-slide">
                                    <div class="price--card d-flex align-items-center h-100">
                                        Стимулирующие и поддерживающие занятия по предметам. Широкий выбор дополнительных занятий гуманитарного, технического, творческого, художественного, декоративно-прикладного и спортивного направления.
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="price--card d-flex flex-column justify-content-center h-100">
                                <div class="h3 accentColor text-md-end">@if(!empty($price)){{$price}} @else 1400 @endif руб.</div>
                ...
                <div class="col-lg-6">
                    <div class="d-none d-lg-block mb-20">
                        <div class="row">
                            <div class="col-6">
                                <div class="price--card d-flex align-items-center h-100">
                                    <p class="mb-0">
                            ...
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                <div class="accordion-body">
                                    <ul class="custom-ul">
                                        ...
                                        <li>Спортивные секции (единоборства, игровые виды спорта)</li>
                                        <li>Хореография</li>
                                        <li>Журналистика</li>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 order-1 order-lg-2 mb-4 mb-lg-0">
                    <img src="/img/main/faq/senior.jpg" alt="faq-img" class="w-100 border-20">
                </div>
            </div>
        </div>
    </section>
