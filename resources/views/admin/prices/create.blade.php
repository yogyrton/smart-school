            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Добавить прайс (все поля обязательны для заполнения, только числа, без отрицательных и десятичных, минимальное число в поле: 0, максимальное число в поле: 99000)</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
