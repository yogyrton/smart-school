            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Добавить прайс (все поля обязательны для заполнения, только числа, без отрицательных и десятичных, максимальное число в поле: 10000)</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="quickForm" novalidate="novalidate" action="{{ route('prices.store') }}" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="blr_gl" placeholder="Цена в белорусских рублях">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Лагерь Жуков Луг</label>
