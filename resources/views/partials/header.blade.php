                        ...
                        <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent">
                            <ul  class="d-flex justify-content-between header-list">
                                    <li class="header-item">
                                        <a class="h5 dropdown-toggle" href="#history">О нас</a>
                                    </li>
                                    <li class="header-item">
                                        <a class="h5 dropdown-toggle" href="#school">Школа</a>
                                    </li>
                                    <li class="header-item">
                                        <a class="h5 dropdown-toggle" href="">Доп.услуги</a>
                                    </li>
                                    <li class="header-item">
                                        <a class="h5 dropdown-toggle" href="">Детский лагерь</a>
                                    </li>
                                    <li class="header-item">
                                        <a class="h5" href="#replies">Отзывы</a>
                                    </li>
                                    <li class="header-item">
                                        <a class="h5" href="">Одно окно</a>
                                    </li>
                                    <li class="header-item">
                                        <a class="h5" href="#order-section">Контакты</a>
                                    </li>
                            </ul>
                        ...
                        <div class="d-none d-lg-flex header-contacts-messengers">
                                <a href="">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <path d="M8.97778 24V12.7385H6V8.68382H8.97778V5.2206C8.97778 2.49917 10.7368 0 14.7898 0C16.4309 0 17.6443 0.15732 17.6443 0.15732L17.5487 3.9437C17.5487 3.9437 16.3112 3.93166 14.9607 3.93166C13.4991 3.93166 13.2649 4.60522 13.2649 5.72316V8.68382H17.6649L17.4734 12.7385H13.2649V24H8.97778Z" fill="#8041FF"/>
                                            </g>
                                            <defs>
                    ...
                    <div class="d-flex justify-content-between container">
                        ...
                        <div class="button-burger" data-bs-toggle="modal" data-bs-target="#burgerModal">
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.30856 18.4843C1.11329 18.6796 1.11329 18.9962 1.30856 19.1914C1.50382 19.3867 1.8204 19.3867 2.01566 19.1914L1.30856 18.4843ZM19.6933 1.51377C19.8886 1.31851 19.8886 1.00193 19.6933 0.806668C19.4981 0.611406 19.1815 0.611406 18.9862 0.806668L19.6933 1.51377ZM2.01566 19.1914L19.6933 1.51377L18.9862 0.806668L1.30856 18.4843L2.01566 19.1914Z" fill="#0D0D0D"/>
                                <path d="M1.35355 0.646447C1.15829 0.451184 0.841709 0.451184 0.646447 0.646447C0.451184 0.841709 0.451184 1.15829 0.646447 1.35355L1.35355 0.646447ZM18.3241 19.0312C18.5194 19.2265 18.836 19.2265 19.0312 19.0312C19.2265 18.836 19.2265 18.5194 19.0312 18.3241L18.3241 19.0312ZM0.646447 1.35355L18.3241 19.0312L19.0312 18.3241L1.35355 0.646447L0.646447 1.35355Z" fill="#0D0D0D"/>
                            </svg>
                        </div>
                    </div>
                </div>
                <div class="modal-body">
                    <div class="container">
                        <nav>
                            <ul>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/#history">О нас</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/">Школа</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/">Доп.услуги</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/">Детский лагерь</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/skazkin-dom">Отзывы</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/blog">Одно окно</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5  italic" href="/#contacts">Контакты</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
