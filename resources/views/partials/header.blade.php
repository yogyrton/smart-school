                ...
                <div class="modal-body">
                    <div class="container">
                        <nav>
                            <ul>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="/#history">О нас</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="/">Школа</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="/">Доп.услуги</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="/">Детский лагерь</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="/skazkin-dom">Отзывы</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="/blog">Одно окно</a>
                                </li>
                                <li>
                                    <a onClick="$('.modal').modal('hide');" class="h5" href="#order-section">Контакты</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
