<section class="priority priority-online pt-80 pb-60 scrollreveal" id="priority-online">
    <div class="container">
                        ...
                        <div class="swiper-wrapper--card">
                            <div class="priority-box d-flex">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <p class="text">Ученики получают возможность обучаться <br> вне зависимости от страны проживания. Освобождается время для дополнительных занятий и хобби. Родительские собрания также проходят онлайн.</p>
                                </div>
                            </div>
                        </div>
                    </div>
