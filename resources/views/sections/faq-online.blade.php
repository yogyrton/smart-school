                    ...
                    <div class="accordion-item">
                        ...
                        <div id="collapseOneFaq" class="accordion-collapse collapse" aria-labelledby="headingOneFaq" data-bs-parent="#accordionFaq">
                            <div class="accordion-body">
                                Частная школа «Смарт Скул» является официальным учреждением образования, имеет официальную лицензию на право осуществления обучения в формате онлайн для учеников по всему миру.
                            </div>
                        </div>
                    </div>
