...
@section('title', 'Одно окно - Средняя школа Смарт Скул')
@section('description', 'Одно окно. Официальный сайт, информация и телефоны для связи с частным учреждением образования “Средней школой “Смарт Скул” +37529-515-60-09.')
